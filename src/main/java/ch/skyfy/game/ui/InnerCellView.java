...
public class InnerCellView extends StackPane implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        number_Label.textProperty().addListener((observable, oldValue, newValue) -> {
            Utils.resizeText(InnerCellView.this.getHeight(), InnerCellView.this.getWidth(), number_Label);
        });
    }
